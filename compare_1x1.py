...
if __name__ == "__main__":
    ...
    callback = Logger(
        ...
        log_path= "1x1_result/DQN_625.csv",
        verbose=1
    )
    ...
    model.save("1x1_result/dqn_1x1_625")
    model = DQN.load("1x1_result/dqn_1x1_625")
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/ppo_log_625.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)
    model.save("1x1_result/ppo_1x1_625")

    model = PPO.load("1x1_result/ppo_1x1_625")
    env.set_save_replay(True)
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/QR_DQN_log_625.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)

    model.save("1x1_result/qrdqn_1x1_625")
    model = QRDQN.load("1x1_result/qrdqn_1x1_625")
    env.set_save_replay(True)
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/a2c_log_625.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)
    model.save("1x1_result/a2c_1x1_625")
    model = A2C.load("1x1_result/a2c_1x1_625")
    env.set_save_replay(True)
    ...
    callback = Logger(
        log_freq=log_interval,
        log_path= "1x1_result/DQN_001.csv",
        verbose=1
    )
    ...
    model.save("1x1_result/dqn_1x1_001")
    model = DQN.load("1x1_result/dqn_1x1_001")
    env.set_save_replay(True)
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/ppo_log_001.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)
    model.save("1x1_result/ppo_1x1_001")

    model = PPO.load("1x1_result/ppo_1x1_001")
    env.set_save_replay(True)
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/QR_DQN_log_001.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)

    model.save("1x1_result/qrdqn_1x1_001")
    model = QRDQN.load("1x1_result/qrdqn_1x1_001")
    env.set_save_replay(True)
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/a2c_log_001.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)
    model.save("1x1_result/a2c_1x1_001")
    model = A2C.load("1x1_result/a2c_1x1_001")
    env.set_save_replay(True)
    ...
    callback = Logger(
        log_freq=log_interval,
        log_path= "1x1_result/DQN_0001.csv",
        verbose=1
    )
    ...
    model.save("1x1_result/dqn_1x1_0001")
    model = DQN.load("1x1_result/dqn_1x1_0001")
    env.set_save_replay(True)
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/ppo_log_0001.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)
    model.save("1x1_result/ppo_1x1_0001")

    model = PPO.load("1x1_result/ppo_1x1_0001")
    env.set_save_replay(True)
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/QR_DQN_log_0001.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)

    model.save("1x1_result/qrdqn_1x1_0001")
    model = QRDQN.load("1x1_result/qrdqn_1x1_0001")
    env.set_save_replay(True)
    ...
    logger = Logger(log_freq=log_interval, log_path="1x1_result/a2c_log_0001.csv", verbose=1)
    model.learn(total_timesteps=env.steps_per_episode * total_episodes, callback=logger)
    model.save("1x1_result/a2c_1x1_0001")
    model = A2C.load("1x1_result/a2c_1x1_0001")
    env.set_save_replay(True)
